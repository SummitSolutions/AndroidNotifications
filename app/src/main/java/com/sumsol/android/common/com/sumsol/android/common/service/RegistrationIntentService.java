...
import com.example.ibaou.myapplication.MainActivity;
...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        Usergrid.initSharedInstance(PushMainActivity.ORG_ID,PushMainActivity.APP_ID,PushMainActivity.BASE_URL, UsergridEnums.UsergridAuthMode.APP);
           ...
           */
        Usergrid.setAppAuth(new UsergridAppAuth("b3U6YjYyOWzsEeelYFDlScT4kw", "b3U6ZMf7Z3RwyW1qF4suOzZjwjiYpCY"));
        Usergrid.authenticateApp();

//        UsergridUserAuth userAuth = new UsergridUserAuth("guest","Guest@#123456");
//        Usergrid.authenticateUser(userAuth);

        UsergridAsync.applyPushToken(this, token, PushMainActivity.NOTIFIER_ID, new UsergridResponseCallback() {
            @Override
